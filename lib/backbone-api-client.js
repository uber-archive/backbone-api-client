...
// Define Model mixin
exports.Model = function BackboneApiClientModel (ModelKlass) {
  return _.extend(ModelKlass.prototype, {
...
exports.Collection = function (CollectionKlass) {
  return _.extend(CollectionKlass.prototype, {
    initialize: function (attrs, options) {
      // Save our apiClient for later
      options = options || {};
      this.apiClient = options.apiClient;
