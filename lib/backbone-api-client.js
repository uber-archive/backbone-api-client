...
exports.Model = function BackboneApiClientModel (Klass) {
  return _.extend(Klass.prototype, {
  // TODO: This is only model. Copy over Collection equivalent as well
    initialize: function (attrs, options) {
      ...
      return Klass.prototype.initialize.call(this, attrs, options);
    },
    ...
    fetch: function (options, cb) {
      ...
      return Klass.prototype.fetch.call(this, options);
    },
    save: function (key, val, options, cb) {
      ...
      if (key == null || typeof key === 'object') {
        ...
        this._bindCallback(options, cb);
        return Klass.prototype.save.call(this, attrs, options);
      /* key, val, [options], cb */
      } else {
        // Fallback `options`
        if (typeof options === 'function') {
        ...
        this._bindCallback(options, cb);
        return Klass.prototype.save.call(this, key, val, options);
      }
    },
    destroy: function (options, cb) {
      this._bindCallback(options, cb);
      return Klass.prototype.destroy.call(this, options);
    },
