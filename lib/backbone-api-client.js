function BackboneApiClient(klass) {
  ...
  _create: function (options, cb) {
    this.apiClient.create(options, cb);
  },
  _update: function (options, cb) {
    this.apiClient.update(this.id, options, cb);
  },
  _patch: function (options, cb) {
    this.apiClient.patch(this.id, options, cb);
  },
  _delete: function (options, cb) {
    this.apiClient['delete'](this.id, options, cb);
  },
  _read: function (options, cb) {
    this.apiClient.read(this.id, options, cb);
  },
...
module.exports = BackboneApiClient;